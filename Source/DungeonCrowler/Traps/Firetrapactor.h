...
public:
    ...
    // Zona de activaci�n � cuando el jugador entra, empieza a disparar
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Trap")
    ...
    // Da�o que hace al jugador
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Trap|Fire")
    float FireDamage = 25.f;

    // Direcci�n de disparo (se puede rotar el actor en el editor)
    ...
    // Tama�o de la zona de activaci�n
